...
const Component = require('/home/karolina/Dokumenty/AGH/TAI/NoteIt/Frontend/src/routes/Notes/components/UserInfo.js').default;
...
/*test('not required proptype userData is actually not required', assert => {
  let props = {};
